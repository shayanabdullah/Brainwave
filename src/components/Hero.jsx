      ...
      <div className="container relative">
        <div className="relative z-1 max-w-248 mx-auto text-center mb-16 md:mb-20 lg:mb-24">
          <h1 className="h1  mb-6">
            Explore the Possibilities of Al Chatting with
          ...
          <p className="body-1 max-w-3xl mx-auto mb-6 text-n-2 lg:mb-8 ">
            Unleash the power of Al within Brainwave. Upgrade your productivity
            with Brainwave, the open Al chat app.
          </p>
        ...
        <div className="relative max-w-92 mx-auto md:max-w-5xl xl:mb-24">
          ...
          <div className="absolute top-[-54%] left-1/2 w-[230%] -translate-x-1/2 md:top-[-46%] md:w-[138%] lg:top-[-104%] ">
            <img
              src={heroBackground}
              alt="hero-bg"
              className="w-full"
